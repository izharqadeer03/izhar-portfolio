...
export const APPLICATIONS: ApplicationDefinition[] = [
  ...
  },
  {
    ...
    title: 'Projects',
    shortTitle: 'Projects',
    description: 'Selected engineering work, case studies and source.',
    category: 'workspace',
    status: 'coming-soon',
    accent: 'violet',
    icon: 'projects',
    keywords: ['work', 'case study', 'portfolio', 'apps', 'repos'],
    defaultSize: { width: 880, height: 600 },
    minSize: { width: 420, height: 340 },
    showOnDesktop: true,
    entry: { kind: 'folder', name: 'Projects', typeLabel: 'File folder' },
    plannedFeatures: ['Case studies with architecture notes', 'Live demos', 'Source repositories'],
  ...
  },
  {
    ...
    description: 'Roles, responsibilities and delivered outcomes.',
    category: 'workspace',
    status: 'coming-soon',
    accent: 'emerald',
    icon: 'experience',
    keywords: ['career', 'jobs', 'history', 'roles', 'timeline'],
    defaultSize: { width: 760, height: 560 },
    minSize: { width: 400, height: 340 },
    showOnDesktop: true,
    entry: { kind: 'folder', name: 'Experience', typeLabel: 'File folder' },
    plannedFeatures: ['Role timeline', 'Impact and outcomes', 'Team and stack context'],
    plannedRelease: 'Phase 2',
  },
  {
    id: 'skills',
    title: 'Skills',
    shortTitle: 'Skills',
    description: 'Languages, frameworks and infrastructure I build with.',
    category: 'workspace',
    status: 'coming-soon',
    accent: 'amber',
    icon: 'skills',
    keywords: ['stack', 'tech', 'tools', 'languages', 'frameworks'],
    defaultSize: { width: 780, height: 540 },
    minSize: { width: 400, height: 340 },
    showOnDesktop: true,
    entry: { kind: 'folder', name: 'Skills', typeLabel: 'File folder' },
    plannedFeatures: ['Stack breakdown by layer', 'Depth indicators', 'Tooling and infrastructure'],
    plannedRelease: 'Phase 2',
  },
  {
    id: 'ai-lab',
    title: 'AI Lab',
    shortTitle: 'AI Lab',
    description: 'Experiments, agents and applied machine intelligence.',
    category: 'workspace',
    status: 'coming-soon',
    accent: 'cyan',
    icon: 'ai',
    keywords: ['ai', 'ml', 'agent', 'assistant', 'llm', 'lab', 'experiments'],
    defaultSize: { width: 860, height: 600 },
    minSize: { width: 420, height: 360 },
    showOnDesktop: true,
    entry: { kind: 'folder', name: 'AI Lab', typeLabel: 'File folder' },
    plannedFeatures: ['Conversational assistant', 'Applied AI experiments', 'Model playgrounds'],
  ...
  },
  {
    ...
    title: 'Resume',
    shortTitle: 'Resume',
    description: 'A readable, downloadable summary of the work.',
    category: 'workspace',
    status: 'coming-soon',
    accent: 'slate',
    icon: 'resume',
    keywords: ['cv', 'download', 'pdf', 'document'],
    defaultSize: { width: 700, height: 620 },
    minSize: { width: 380, height: 360 },
    showOnDesktop: true,
    entry: { kind: 'document', name: 'Resume.pdf', typeLabel: 'PDF Document' },
    plannedFeatures: ['Inline document viewer', 'PDF download', 'Print-ready layout'],
    plannedRelease: 'Phase 2',
  },
  {
    id: 'contact',
    title: 'Contact',
    shortTitle: 'Contact',
    description: 'Start a conversation about work or collaboration.',
    category: 'workspace',
    status: 'coming-soon',
    accent: 'rose',
    icon: 'contact',
    keywords: ['email', 'message', 'hire', 'reach', 'connect'],
    defaultSize: { width: 640, height: 520 },
    minSize: { width: 360, height: 340 },
    showOnDesktop: true,
    entry: { kind: 'link', name: 'Contact.url', typeLabel: 'Internet Shortcut' },
    plannedFeatures: ['Direct message form', 'Availability window', 'Social channels'],
    plannedRelease: 'Phase 2',
  },
  {
    id: 'files',
